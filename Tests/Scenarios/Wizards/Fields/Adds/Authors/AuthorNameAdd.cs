...
{
    class WizardFieldAuthorNameAdd : TestDecorator
    {
        ...
        public override void Execute()
        {
            ...
            Create create = new Create()
            {
                ids = new System.Collections.Generic.List<TableComponentInput>() 
                {
                    new TableComponentInput() {
                        id = Config.data["authors_table_name_component_id"],
                        isUserTable = false,
                        userTableType = null
                    }
                },
            ...
            Config.data["author_wizard_name_field_id"] = HTTP.Name("Wizard Field Add Testi")
