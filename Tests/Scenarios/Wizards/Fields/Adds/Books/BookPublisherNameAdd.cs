...
{
    class WizardFieldBookPublisherNameAdd : TestDecorator
    {
        ...
        public override void Execute()
        {
            ...
            Create create = new Create()
            {
                ids = new System.Collections.Generic.List<TableComponentInput>() 
                {
                    new TableComponentInput() {
                        id = Config.data["books_table_publisher_name_component_id"],
                        isUserTable = false,
                        userTableType = null
                    }
                },
            ...
            Config.data["book_wizard_publisher_name_field_id"] = HTTP.Name("Wizard Field Add Testi")
