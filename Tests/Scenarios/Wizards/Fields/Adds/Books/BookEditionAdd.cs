...
{
    class WizardFieldBookEditionAdd : TestDecorator
    {
        ...
        public override void Execute()
        {
            ...
            Create create = new Create()
            {
                ids = new System.Collections.Generic.List<TableComponentInput>() 
                {
                    new TableComponentInput() {
                        id = Config.data["books_table_edition_component_id"],
                        isUserTable = false,
                        userTableType = null
                    }
                },
            ...
            Config.data["book_wizard_edition_field_id"] = HTTP.Name("Wizard Field Add Testi")
