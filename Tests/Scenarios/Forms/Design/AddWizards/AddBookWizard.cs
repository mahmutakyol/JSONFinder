...
{
    class FormDesignAddBookWizard : TestDecorator
    {
        ...
        public override void Execute()
        {
            ...
            wizardIds.Add(Config.data["book_registration_wizard_id"]);
            wizard.formId = Config.data["book_registration_form_id"];
            wizard.wizardIds = wizardIds;

            Config.data["form_book_wizard_id"] = HTTP.Name("Form Design Add Wizard Test")
